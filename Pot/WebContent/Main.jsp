	...
	<div class="wrap">
		...
		<div class="main_text0">
			...
			<ul class="icon">
				<li>
					...
					<div class="contens3">
						감성 까지 똑똑한 화분 IO-OT는<br>집안을 사랑스럽게 만들어줍니다.
					</div>
				</li>
		...
		<div class="main_text1">
			...
			<div class="service">
				...
				<div class="contens4">
					<h3>반려식물의 놀라운 효과!</h3>
					어린시절 다들 작은 화분을 키워본 경험이 있으신가요?<br> 정성들여 키운 작은 화분에서 조심스레 모습을 들어낸
					새싹을 본 마음은 아마도 설렘으로 가득 찼을 겁니다.<br>
					<br> 코로나 19사태 이후 집에서 시간을 보내는 사람들이 늘어나면서 이제는 반려동물 뿐만이 아닌
					'반려식물'로 불릴 정도로 인기가 급부상 하면서 반려식물은 우리와 교감을 나눌 수 있는 삶의 일원으로 자리 잡았습니다.<br>
					<br> 서울시 1인가구 어르신 330명을 대상으로 조사결과 무려 92%가 우울감 및 외로움 해소에 도움이
					되었다고 답했는데요, 이처럼 반려식물은 심리적 안정감뿐 아니라 집안 공기 정화 효과 및 인테리어까지 일석이조의 효과를
					가져다 주는 반려식물! <strong>스마트화분 'IO-OT''로 일상의 즐거움을 느껴보세요!</strong>
				</div>
			</div>
